...
const rows = [
    ...
    createData(invoice.invoiceNumber, invoice.billDate,invoice.supplierName,invoice.payment, grandTotal,invoice.items),
  ];
  function createData( invoiceNumber,billDate,supplierName,payment,grandTotal,items) {
    return {
    invoiceNumber,
    billDate,
    supplierName,
